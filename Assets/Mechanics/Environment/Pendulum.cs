...
public class Pendulum : MonoBehaviour
{
    ...
    public Quaternion angleOffset = Quaternion.Euler(90, 0, 0);
    float ropeLength = 2f;
    ...
    void Update()
    {
        ...
        Bob.transform.rotation = (angleOffset * Quaternion.LookRotation(Pivot.transform.position - newPosition, Vector3.forward));
