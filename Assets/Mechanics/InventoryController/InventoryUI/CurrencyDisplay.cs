...
namespace Armere.Inventory.UI
{
	public class CurrencyDisplay : MonoBehaviour
	{
		...
		private void Start()
		{
			...
			{
				SetCurrencyDisplay(playerInventory.currency.currency);
				playerInventory.currency.onPanelUpdated += OnCurrencyUpdated;
			}
		}
		...
		{
			float time = 0;
			uint newCurrency = playerInventory.currency.currency;
