...
public struct BinaryTupleSerializer<T1, T2> : IBinaryVariableSerializer<(T1, T2)>
	where T1 : IBinaryVariableSerializer<T1>, new()
	where T2 : IBinaryVariableSerializer<T2>, new()
{
	(T1, T2) data;
