...
public static class EditorUtilities
{
    ...
    static WorldObjectDataComponentSettings s_ClipboardContent;
    ...
    internal static bool DrawHeader(string title, SerializedProperty group, WorldObjectDataComponentSettings target, Action resetAction, Action removeAction)
    {
    ...
    static void ShowHeaderContextMenu(Vector2 position, WorldObjectDataComponentSettings target, Action resetAction, Action removeAction)
    {
    ...
    static void CopySettings(WorldObjectDataComponentSettings target)
    {
        Assert.IsNotNull(target);
        ...
        s_ClipboardContent = (WorldObjectDataComponentSettings)ScriptableObject.CreateInstance(target.GetType());
        EditorUtility.CopySerializedIfDifferent(target, s_ClipboardContent);
    }

    static void PasteSettings(WorldObjectDataComponentSettings target)
    {
        Assert.IsNotNull(target);
    ...
    static bool CanPaste(WorldObjectDataComponentSettings target)
    {
